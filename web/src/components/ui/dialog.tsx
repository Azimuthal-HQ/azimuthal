...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-[var(--text-lg)] font-semibold leading-none tracking-tight text-[var(--color-text)]',
      className,
    )}
    {...props}
  />
