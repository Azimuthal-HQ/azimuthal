...
docs: ## Generate OpenAPI 3.0 spec from handler annotations
	...
	@swag init \
		--generalInfo main.go \
		--dir ./cmd/server,./internal/core/api,./internal/core/api/auth,./internal/core/api/tickets,./internal/core/api/wiki,./internal/core/api/projects,./internal/core/api/spaces,./internal/core/api/comments,./internal/core/api/notifications,./internal/core/api/teams,./internal/core/api/grants \
		--output docs/api \
		--outputTypes yaml \
		--v3.1 \
		--parseInternal \
