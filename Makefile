...
docs: ## Generate OpenAPI 3.0 spec from handler annotations
	...
	@swag init \
		--generalInfo main.go \
		--dir ./cmd/server,./internal/core/api,./internal/core/api/auth,./internal/core/api/tickets,./internal/core/api/wiki,./internal/core/api/projects,./internal/core/api/relations,./internal/core/api/spaces,./internal/core/api/comments,./internal/core/api/notifications,./internal/core/api/portal,./internal/core/api/teams,./internal/core/api/grants,./internal/core/api/admin,./internal/core/api/invites,./internal/core/api/credlinks,./internal/core/api/search,./internal/core/api/shares,./internal/core/api/attachments,./internal/core/api/avatar \
		--output docs/api \
		--outputTypes yaml \
		--v3.1 \
		--parseInternal \
