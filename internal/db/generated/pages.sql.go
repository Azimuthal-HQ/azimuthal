...
const softDeletePageInSpace = `-- name: SoftDeletePageInSpace :exec
UPDATE pages SET deleted_at = now()
WHERE id = $1 AND space_id = $2 AND deleted_at IS NULL
`

type SoftDeletePageInSpaceParams struct {
	PageID  uuid.UUID `json:"page_id"`
	SpaceID uuid.UUID `json:"space_id"`
}
...
func (q *Queries) SoftDeletePageInSpace(ctx context.Context, arg SoftDeletePageInSpaceParams) error {
	_, err := q.db.Exec(ctx, softDeletePageInSpace, arg.PageID, arg.SpaceID)
	return err
}
